...
class AutomataFinito {
    private:
        ...
        */
        void generar_cadena_recursivamente (
            ...
            int estado )
        {
            ...
            for ( int i = 'a' ; i <= 'z' ; i++ )
            {
                if ( transiciones_aux.count({estado, i}) || transiciones_aux.count({estado, 'E'}))
                {
                    ...
                    generar_cadena_recursivamente (transiciones_aux, acumulado, cadena, estado_sig);
                    acumulado.pop_back();
                }
            }
        }
    ...
    public:
        ...
        */
        ...
        {
            transiciones[{ inicio, simbolo }].erase(fin);
        }
        ...
        */
        string generar_cadena()
        {
            ...
            generar_cadena_recursivamente ( transiciones_aux, acumulado, cadena, estado );
        ...
        set<int> obtener_estados_finales ()
        {
